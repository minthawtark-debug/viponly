...
const Members = () => {
  ...
  useEffect(() => {
    ...
    // Allow access if they have vip_access and target_page is 'member'
    if (vipAccess === 'true' && targetPage === 'member') {
      setHasAccess(true);
    } else {
      setHasAccess(false);
    }
        ...
        <main className="container mx-auto px-4 py-24 flex flex-col items-center justify-center min-h-[70vh]">
          <div className="text-center animate-fade-in">
            ...
            <p className="text-muted-foreground text-lg max-w-md mx-auto">
              You need a valid Member access link to view this content.
            </p>
            <Link 
              to="/"
